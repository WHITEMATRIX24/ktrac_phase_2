...
export function FatalReportDataTable<TData, TValue>({
  columns,
  data,
  searchKey,
  tableLabel,
                ...
                >
                  {headerGroup.headers.map((header) => {
                    return (
                      <TableHead
                        key={header.id}
                        className="text-white text-sm px-2 py-2 whitespace-normal break-words min-w-[200px]"
                      >
                ...
                table.getRowModel().rows.map((row, index) => (
                  ...
                  >
                    {row.getVisibleCells().map((cell) => (
                      <TableCell
                        key={cell.id}
                        className="text-sm px-2 py-2 whitespace-normal break-words min-w-[200px]"
                      >
                        {flexRender(
