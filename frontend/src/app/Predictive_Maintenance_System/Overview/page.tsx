  ...
  const dummyData = [
    {
      ...
      value: 5450,
      change: "0",
      icon: <BusFront className="w-12 h-12 text-grey opacity-40" />,
    },
    {
      title: "Buses Under Maintenance",
      value: 383,
      change: "0",
      icon: <Wrench className="w-12 h-12 text-grey opacity-40" />,
    },
    {
      title: "High Risk Alerts",
      value: 124,
      change: "0",
      icon: <TriangleAlert className="w-12 h-12 text-grey opacity-40" />,
    },
    {
      title: "Upcoming Services",
      value: 340,
      change: "0",
      icon: <CalendarClock className="w-12 h-12 text-grey opacity-40" />,
    },
  ];
  return (
          ...
          <div className="grid grid-cols-2 gap-2 mx-6 ">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Upcoming predicted failures for top at-risk buses
                </CardDescription>
              </CardHeader>
          ...
          <div className="grid grid-cols-2 gap-2 mx-6 ">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Upcoming predicted parts requirement and their availablitiy
                </CardDescription>
              </CardHeader>
              <div className="px-4 lg:pl-6">
                <LowStockPartsTable />
