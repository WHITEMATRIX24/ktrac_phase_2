                                                ...
                                                <div className="bg-white border border-gray-300 rounded-[4px] p-4">
                                                    ...
                                                    <div className="grid grid-cols-2 gap-3">
                                                        ...
                                                        <div
                                                            ...
                                                            onClick={() => setPreviewImage("https://example.com/vehicle-damage.jpg")}
                                                        >
                                                            <div className="bg-gray-200 border border-gray-300 rounded h-24 flex items-center justify-center">
                                                                <div className="text-gray-500 text-center">
                                                                    ...
                                                                    <span className="text-xs mt-1 block">Vehicle Damage</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div
                                                            className="cursor-pointer"
                                                            onClick={() => setPreviewImage("https://example.com/scene.jpg")}
                                                        >
                                                            <div className="bg-gray-200 border border-gray-300 rounded h-24 flex items-center justify-center">
                                                                <div className="text-gray-500 text-center">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 mx-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                                    ...
                                                                    <span className="text-xs mt-1 block">Accident Scene</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div
                                                            className="cursor-pointer"
                                                            onClick={() => setPreviewImage("https://example.com/documents.jpg")}
                                                        >
                                                            <div className="bg-gray-200 border border-gray-300 rounded h-24 flex items-center justify-center">
                                                                <div className="text-gray-500 text-center">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 mx-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                        ...
                                                        <div
                                                            className="cursor-pointer"
                                                            onClick={() => setPreviewImage("https://example.com/other-vehicle.jpg")}
                                                        >
                                                            <div className="bg-gray-200 border border-gray-300 rounded h-24 flex items-center justify-center">
                                                                <div className="text-gray-500 text-center">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 mx-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                                    ...
                                                                    <span className="text-xs mt-1 block">Other Vehicle</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
