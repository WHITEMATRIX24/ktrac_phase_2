...
const columns = [
    ...
    },
    {
        ...
        header: "Training / STC", // Cleaned up header name
        id: "Training",
    },
    {
        accessorKey: "Enroute",
...
function getInitialDates() {
    ...
    return {
        ...
        initialEnd: new Date(yesterday.getTime() + 86400000).toISOString().split('T')[0]
    };
}
...
export default async function ReportPage() {
    ...
    return (
        <div className='p-4'>
            ...
            <ReportTable data={busData} columns={columns} />
        </div>
    );
}