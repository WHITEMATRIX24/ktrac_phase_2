  ...
  const financeData = [
    {
      ...
      value: 1294500,
      change: "+2.2%",
      icon: <Wallet className="w-15 h-15 text-grey opacity-40" />,
    },
    {
      title: "Total Expenses",
      value: 9458000,
      change: "+1.2%",
      icon: <Banknote className="w-12 h-12 text-grey opacity-40" />,
    },
    {
      title: "Vendor Payments Pending",
      value: 2148000,
      change: "0",
      icon: <Clock className="w-12 h-12 text-grey opacity-40" />,
    },
    {
